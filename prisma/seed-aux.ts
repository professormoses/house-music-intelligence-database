...
export const SEED_LABELS = [
  ...
  },
  {
    ...
    artistRoster: ['Da Capo', 'Caiiro', 'Manoo', 'Boddhi Satva'],
    confidenceScore: 70,
  ...
  },
  {
    ...
    artistRoster: ['Kid Fonque', 'Jazzuelle'],
    confidenceScore: 64,
  ...
  },
  {
    ...
    artistRoster: ['Black Coffee', 'DJ Kent', 'Culoe De Song'],
    confidenceScore: 62,
    sourceUrls: ['https://www.afrohouse.se/labels/'],
  },
  {
    ...
    country: 'South Africa',
    genres: ['Afro House', 'Soulful House', 'Deep House'],
    artistRoster: ['Culoe De Song', 'Da Capo'],
    confidenceScore: 60,
    sourceUrls: ['https://www.afrohouse.se/labels/'],
  },
  {
